  ...
  <div style="margin-bottom: 60px">
    ...
    <ion-card>
      ...
      <ion-item>
        ...
        <ion-toggle
          v-if="addRoadProblemForm.potentialHazard"
          checked="true"
          @ionChange="
  ...
  methods: {
    ...
    getcheckRoadProblem() {
      ...
      API.getcheckRoadProblem(params).then((response) => {
        ...
        if (this.volumeCheck) {
          this.cubeOrSquareLength = this.addRoadProblemForm.specificSize.split(
            "*"
          )[0];
          this.cubeOrSquareWidth = this.addRoadProblemForm.specificSize.split(
            "*"
          )[1];
          this.cubeOrSquareHeight = this.addRoadProblemForm.specificSize.split(
            "*"
          )[2];
